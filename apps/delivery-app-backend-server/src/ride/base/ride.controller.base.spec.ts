  ...
  test("POST /rides", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dropoffTime: CREATE_RESULT.dropoffTime.toISOString(),
      ...
      .expect([
        {
          ...
          dropoffTime: FIND_MANY_RESULT[0].dropoffTime.toISOString(),
  ...
  test("GET /rides/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dropoffTime: FIND_ONE_RESULT.dropoffTime.toISOString(),
